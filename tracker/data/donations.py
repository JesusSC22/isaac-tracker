...
GREED_DONATION_MILESTONES: list[dict] = [
    ...
    {"amount":   68, "achievement_id": 245, "name": "Cain holds Paperclip",
     "description": "Cain empieza cada run con Paperclip: trinket que abre cofres cerrados sin gastar llaves."},
    ...
    {"amount":  439, "achievement_id": 248, "name": "Eve now holds Razor Blade",
     "description": "Eve empieza cada run con Razor Blade: activo que cuesta medio corazón y da +1.2 de daño durante la sala."},
    ...
    {"amount":  879, "achievement_id": 250, "name": "Lost holds Holy Mantle",
     "description": "The Lost empieza cada run con Holy Mantle: escudo sagrado que anula el primer impacto en cada sala."},
